// Created by LiuSainan on 2022-11-06 21:52:43
...
func ComputeReshardTable(src Nodes, numSlots int) []Slot {
	var moved []Slot

	sources := src.SortByFunc(func(a, b *ClusterNode) bool { return a.TotalSlots() < b.TotalSlots() })
	sourceTotSlots := 0
